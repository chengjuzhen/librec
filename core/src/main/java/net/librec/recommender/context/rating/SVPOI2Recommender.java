...
public class SVPOI2Recommender extends SocialRecommender {
        ...
        for (int iter = 1; iter <= numIterations; iter++) {
            ...
            for(int itemIdx : itemMappingData.values()){//g(V*P) = logistic(V*P)  //此处遍历itemIdx不能用 itemMappingData 了，待修改！!!
                ...
                for(int j=0; j<1000; j++){
                    ...
                    double photoError = photoPredictValue - weight * photoValue;
                    ...
                    for(int factorIdx = 0; factorIdx < numFactors; factorIdx++){
                        ...
                        tempItemFactors.add(itemIdx, factorIdx, regPhoto * photoFactorValue * photoError * photoFactorValue);
                        itemPhotoTempFactors.add(pixIdx, factorIdx, regPhoto * itemFactorValue * photoError * itemFactorValue + regItemPhoto * photoFactorValue );
